<header class="banner">
  ...
  <div class="d-flex mid-header justify-content-between">
    <a class="brand" href="<?php echo e(home_url('/')); ?>"> <img src="<?= App\asset_path('images/brand.jpg'); ?>" alt="<?php echo e(get_bloginfo('name', 'display')); ?>"> </a>
    <a href="#" class="header-banner"><img src="<?= App\asset_path('images/esta-wide-banner.jpg'); ?>" alt="Prenez des Vacanaces aux USA sans VISA"></a>
