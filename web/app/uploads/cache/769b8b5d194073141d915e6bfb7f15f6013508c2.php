<div id="client-form" class="slide">
  ...
  <form class="form-content carousel-inner">
    <input type="hidden" value="<?php echo e($post->post_title); ?>" name="cat">
    <div id="step-1" class="step row carousel-item active" data-height="250">
      <label class="col-6">
        <input type="radio" name="type_propriete" value="Propriétaire">
        <span>
          <img src="<?= App\asset_path('images/icons/proprietaire-icon.png'); ?>" alt="Propriétaire">
      ...
      <label class="col-6">
        ...
        <span>
          <img src="<?= App\asset_path('images/icons/locataire-icon.png'); ?>" alt="Locataire">
          <span>Locataire</span>
        </span>
      </label>
    </div>
    ...
    <div id="step-2" class="step row carousel-item" data-height="430">
      <label class="col-6">
        ...
        <span>
          <img src="<?= App\asset_path('images/icons/bureau-icon.png'); ?>" alt="Maison & Villa">
      ...
      <label class="col-6">
        ...
        <span>
          <img src="<?= App\asset_path('images/icons/appartement-icon.png'); ?>" alt="Appartement">
      ...
      <label class="col-6">
        ...
        <span>
          <img src="<?= App\asset_path('images/icons/bureau-icon.png'); ?>" alt="Commerce ou Bureau">
      ...
      <label class="col-6">
        ...
        <span>
          <img src="<?= App\asset_path('images/icons/autre-icon.png'); ?>" alt="Autre...">
          <span>Autre...</span>
        </span>
      </label>
    </div>
    ...
    <div id="step-3" class="step row carousel-item" data-height="430">
      <label class="col-6">
        ...
        <span>
          <img src="<?= App\asset_path('images/icons/remplacement-icon.png'); ?>" alt="Remplacement">
      ...
      <label class="col-6">
        ...
        <span>
          <img src="<?= App\asset_path('images/icons/installation-neuve-icon.png'); ?>" alt="Installation neuve">
      ...
      <label class="col-6">
        ...
        <span>
          <img src="<?= App\asset_path('images/icons/reparation-icon.png'); ?>" alt="Réparation">
      ...
      <label class="col-6">
        ...
        <span>
          <img src="<?= App\asset_path('images/icons/entretien-icon.png'); ?>" alt="Entretien">
          <span>Entretien</span>
        </span>
      </label>
    </div>
    ...
    <div id="step-4" class="step row carousel-item" data-height="430">
      <label class="col-6">
        ...
        <span>
          <img src="<?= App\asset_path('images/icons/rapide-icon.png'); ?>" alt="Au plus vite">
      ...
      <label class="col-6">
        ...
        <span>
          <img src="<?= App\asset_path('images/icons/moin-2mois-icon.png'); ?>" alt="Moins de 2 mois">
      ...
      <label class="col-6">
        ...
        <span>
          <img src="<?= App\asset_path('images/icons/2mois-icon.png'); ?>" alt="Plus de 2 mois">
      ...
      <label class="col-6">
        ...
        <span>
          <img src="<?= App\asset_path('images/icons/annee-icon.png'); ?>" alt="Dans l'année">
    ...
    <div id="step-5" class="step last-step row carousel-item" data-height="730">
      <div class="col-12">
        <h2>
          <img src="<?= App\asset_path('images/icons/handshake-icon.png'); ?>">Veuillez remplir le formulaire !</h2>
    ...
    <div id="step-6" class="step congrats-step row carousel-item" data-height="350">
      <div class="col-12">
        ...
        <img src="<?= App\asset_path('images/brand.jpg'); ?>" alt="logo">
