          ...
          <?php $__currentLoopData = $all_pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="card">
              <div class="card-heading">
                <a href="<?php echo e(App::permalink($page->ID)); ?>"><img src="<?php echo e(get_the_post_thumbnail_url( $page->ID, 'thumbnail' )); ?>" class="card-img-top" alt="<?php echo e($page->post_title); ?>"></a>
              </div>
